...
class EntityExtraction4Cmcc(object):
    'format the entity labels to fitting the model, 9 labels in total '
    def __init__(self):
...
class EntityLabelCmcc(object):
    def __init__(self):
        ...
        self.entity_attribute = self.read_entity_from_config(self.config_path + 'attribute__merge.json')
        ...
        self.pattern_data.append(re.compile(r'\d+[M兆]'))
            ...
            with open(path_read, encoding='utf-8', mode='r') as file_read:
                ...
                for line in lines:
                    ...
                    for pattern in pattern_list:
                        ...
                        for iter in iters:
                            if (get_entity_flag(line, iter.group())):
                                print(iter.group())
                                counter_entity += 1
...
if __name__ == '__main__':
    ...
    # # file_path = '_merge.standardquery'
